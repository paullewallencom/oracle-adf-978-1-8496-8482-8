...
Open MultiRegionSample workspace in JDeveloper 11.1.2.2.0 or higher
...
-ViewController Project
    - main.jsf: This page demonstrates the multi task flow binding ( creating Task Flow bindings on the fly)	
...
-------------------------
1. Select the desired main.jsf page in ViewController project, right click and Run
   Click on the 'Display More Taskflows' button.
