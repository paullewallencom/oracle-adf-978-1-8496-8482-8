...
public class DepartmentVORowImpl extends ViewRowImpl {
     ...
     * @param attrDef The attribute defintion for which the hints need to be created.
     * @return an instance of </code>ViewRowAttrHintsImpl</code>
     */
    protected ViewRowAttrHintsImpl createViewRowAttrHints(AttributeDefImpl attrDef) {
        return new CustomRowAAttrHintsImpl(attrDef, this);
    }
    ...
    static class CustomRowAAttrHintsImpl extends ViewRowAttrHintsImpl {
        ...
        public String getHint(LocaleContext locale, String sHintName) {
            if (getViewAttributeDef().getName().equals("ManagerId")) {
                if (ViewRowAttrHintsImpl.HINT_NAME_DISPLAY_HINT.equals(sHintName)) {
                    return isNormalUser() ? ViewRowAttrHintsImpl.ATTRIBUTE_DISPLAY_HINT_HIDE :
                           ViewRowAttrHintsImpl.ATTRIBUTE_DISPLAY_HINT_DISPLAY;
                }
            }
