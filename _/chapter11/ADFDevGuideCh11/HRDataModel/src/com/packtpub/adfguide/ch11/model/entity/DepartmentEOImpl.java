...
public class DepartmentEOImpl extends EntityImpl {
    ...
    public boolean validateDepartmentName(String departmentname) {
        System.out.println("--------- validateDepartmentName -----------");
        return true;
    }
    ...
    public boolean validateManagerId(Integer managerid) {
        System.out.println("--------- validateManagerId -----------");
        return true;
    }

    /**
     * Validation method for DepartmentEO.
     */
    public boolean validateDepartmentTxnLevel(ArrayList ctxList) {
        System.out.println("--------- validateDepartmentTxnLevel -----------");
        return true;
    }
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        return EntityDefImpl.findDefObject("com.packtpub.adfguide.ch11.model.entity.DepartmentEO");
    }
     ...
     * Validation method for DepartmentEO.
     */
    public boolean validateDepartmentEOLevel() {
        System.out.println("--------- validateDepartmentEOLevel -----------");
        return true;
    }
