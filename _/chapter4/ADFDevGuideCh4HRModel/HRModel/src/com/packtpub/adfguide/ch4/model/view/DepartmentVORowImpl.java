...
public class DepartmentVORowImpl extends ViewRowImpl {
    ...
    public enum AttributesEnum {
        ...
        ATransientAttribute {
            public Object get(DepartmentVORowImpl obj) {
                return obj.getATransientAttribute();
            }

            public void put(DepartmentVORowImpl obj, Object value) {
                obj.setATransientAttribute((String)value);
            }
        }
        ,
        EmployeeVO {
    ...
    public static final int ATRANSIENTATTRIBUTE = AttributesEnum.ATransientAttribute.index();
    ...
    public EntityImpl getDepartmentEO() {
        return (EntityImpl)getEntity(ENTITY_DEPARTMENTEO);
    }
    ...
    /**
     * Gets the attribute value for the calculated attribute ATransientAttribute.
     * @return the ATransientAttribute
     */
    public String getATransientAttribute() {
        return (String) getAttributeInternal(ATRANSIENTATTRIBUTE);
    }

    /**
     * Sets <code>value</code> as the attribute value for the calculated attribute ATransientAttribute.
     * @param value value to set the  ATransientAttribute
     */
    public void setATransientAttribute(String value) {
        setAttributeInternal(ATRANSIENTATTRIBUTE, value);
    }
